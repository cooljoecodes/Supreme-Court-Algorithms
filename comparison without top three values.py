...
accuracy_values = []
auroc_values = []
lines = ['Accuracy (LightGBM)','Reduced Accuracy (LightGBM)']
lines2 = ['AUROC (LightGBM)', 'Reduced AUROC (LightGBM)']
...
ax1.set_title('Original and Reduced Accuracy and AUROC for LightGBM (Sorted by Accuracy)')
